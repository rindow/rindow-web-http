...
class Request extends Message implements RequestInterface
{
    ...
    {
        $message = clone $this;
        $message->set('requestTarget',$requestTarget,$this->secret);
        return $message;
    }
    ...
    public function withMethod($method)
    {
        ...
        $message = clone $this;
        $message->set('method',$method,$this->secret);
        return $message;
    }
    ...
    {
        $message = clone $this;
        $message->set('uri',$uri,$this->secret);
        ...
        $message->setHeader('Host',$host,$this->secret);
        return $message;
    }
}
